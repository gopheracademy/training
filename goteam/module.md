...
```
go get github.com/gopheracademy/code
```
...
[Ben Johnson Article](https://medium.com/@benbjohnson/standard-package-layout-7cdbc8391fc1)
...
[https://github.com/golang/go/blob/master/src/fmt/format.go#L12](https://github.com/golang/go/blob/master/src/fmt/format.go#L12)
[https://github.com/golang/go/blob/master/src/fmt/format.go#L326](https://github.com/golang/go/blob/master/src/fmt/format.go#L326)
[https://github.com/golang/go/blob/master/src/flag/flag.go#L293](https://github.com/golang/go/blob/master/src/flag/flag.go#L293)
...
If the package deals with multiple types, keep the logic for each type in its own source file:
	...
	goteam/exercises/inventory/postgres
...
In goteam/exercises/inventory/ there's a skeleton application with all the interfaces designed.
