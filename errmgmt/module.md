...
<code src="errmgmt/includes/errs/errtype.go"> 
...
<code src="errmgmt/includes/errs/errstruct.go">
...
<code src="errmgmt/includes/errs/owntype.go">
...
<code src="errmgmt/includes/errs/knowntype.go">
...
<code src="errmgmt/includes/errs/structcheck.go">
...
<code src="errmgmt/includes/errs/handleonce.go">
...
<code src="errmgmt/includes/errs/handleonce2.go">
...
<code src="errmgmt/includes/errs/openfile.go">
...
Write a small application that has at least 3 function calls and uses `github.com/pkg/errors` to propagate errors to `main()`
